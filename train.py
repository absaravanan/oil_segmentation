...
def val(args, model, dataloader):
    ...
    with torch.no_grad():
        ...
        for i, (data, label) in enumerate(dataloader):
            ...
            # print (precision)
            if len(label.flatten()) == len(predict.flatten()):
...
def train(args, model, optimizer, dataloader_train, dataloader_val):
    ...
    for epoch in range(args.num_epochs):
        ...
        for i, (data, label) in enumerate(dataloader_train):
            ...
            #                 os.path.join(args.save_model_path, 'latest_dice_loss'+ str(i)+str(epoch)+'.pth'))
...
def main(params):
    ...
    dataset_val = CamVid(train_path, train_label_path, csv_path, scale=(args.crop_height, args.crop_width),
...
# 0.024820
        # '--pretrained_model_path', '/home/ryzen/ai/abs/BiSeNet/checkpoints_18_sgd/latest_dice_loss50001.pth'
