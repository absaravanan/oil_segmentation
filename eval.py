...
def main(params):
    ...
    test_path = "/home/ryzen/ai/data/coco/aadhaar_mask/val/images"
    # test_path = os.path.join(args.data, 'train')
    test_label_path = "/home/ryzen/ai/data/coco/aadhaar_mask/val/annotations"
...
if __name__ == '__main__':
    params = [
        ...
        '--data', '/home/ryzen/ai/data/coco/aadhaar_mask/val/images',
        '--cuda', '0',
